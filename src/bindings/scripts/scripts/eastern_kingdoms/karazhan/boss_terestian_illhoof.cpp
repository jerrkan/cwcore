...
struct CW_DLL_DECL mob_kilrekAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_demon_chainAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_fiendish_impAI : public ScriptedAI
{
