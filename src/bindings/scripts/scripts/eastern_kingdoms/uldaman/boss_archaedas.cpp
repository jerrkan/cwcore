...
struct CW_DLL_DECL boss_archaedasAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_archaedas_minionsAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_stonekeepersAI : public ScriptedAI
{
