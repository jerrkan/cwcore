...
struct CW_DLL_DECL boss_kalecgosAI : public ScriptedAI
{
...
struct CW_DLL_DECL boss_sathrovarrAI : public ScriptedAI
{
...
struct CW_DLL_DECL boss_kalecAI : public ScriptedAI
{
    ScriptedInstance *pInstance;
