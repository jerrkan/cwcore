...
struct CW_DLL_DECL mob_freed_soulAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_restless_soulAI : public ScriptedAI
{
...
struct CW_DLL_DECL mobs_spectral_ghostly_citizenAI : public ScriptedAI
{
