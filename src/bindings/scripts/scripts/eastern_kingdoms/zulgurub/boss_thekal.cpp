...
struct CW_DLL_DECL boss_thekalAI : public ScriptedAI
{
...
//Zealot Lor'Khan
struct CW_DLL_DECL mob_zealot_lorkhanAI : public ScriptedAI
{
...
//Zealot Zath
struct CW_DLL_DECL mob_zealot_zathAI : public ScriptedAI
{
