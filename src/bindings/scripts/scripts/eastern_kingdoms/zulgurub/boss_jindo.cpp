...
struct CW_DLL_DECL boss_jindoAI : public ScriptedAI
{
...
//Healing Ward
struct CW_DLL_DECL mob_healing_wardAI : public ScriptedAI
{
...
//Shade of Jindo
struct CW_DLL_DECL mob_shade_of_jindoAI : public ScriptedAI
{
