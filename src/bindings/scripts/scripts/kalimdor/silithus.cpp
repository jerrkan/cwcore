...
######*/
struct CW_DLL_DECL npc_anachronos_the_ancientAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_qiraj_war_spawnAI : public ScriptedAI
{
...
struct CW_DLL_DECL npc_anachronos_quest_triggerAI : public ScriptedAI
{
