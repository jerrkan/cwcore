...
struct CW_DLL_DECL mobs_spitelashesAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_rizzle_sprysprocketAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_depth_chargeAI : public ScriptedAI
{
