...
struct CW_DLL_DECL npc_kerlonianAI : public FollowerAI
{
...
struct CW_DLL_DECL npc_prospector_remtravelAI : public npc_escortAI
{
...
struct CW_DLL_DECL npc_threshwackonatorAI : public FollowerAI
{
