...
struct CW_DLL_DECL mob_doomfireAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_doomfire_targettingAI : public ScriptedAI
{
...
struct CW_DLL_DECL boss_archimondeAI : public hyjal_trashAI
{
