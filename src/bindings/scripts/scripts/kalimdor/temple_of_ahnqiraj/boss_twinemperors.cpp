...
struct CW_DLL_DECL boss_twinemperorsAI : public ScriptedAI
{
...
struct CW_DLL_DECL boss_veknilashAI : public boss_twinemperorsAI
{
...
struct CW_DLL_DECL boss_veklorAI : public boss_twinemperorsAI
{
