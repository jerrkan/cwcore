...
struct CW_DLL_DECL boss_svalaAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_ritual_channelerAI : public ScriptedAI
{
...
struct CW_DLL_DECL boss_svala_sorrowgraveAI : public ScriptedAI
{
