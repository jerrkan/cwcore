...
struct CW_DLL_DECL npc_raliq_the_drunkAI : public ScriptedAI
{
...
struct CW_DLL_DECL npc_salsalabimAI : public ScriptedAI
{
...
struct CW_DLL_DECL npc_kservantAI : public npc_escortAI
{
public:
...
struct CW_DLL_DECL npc_dirty_larryAI : public ScriptedAI
{
