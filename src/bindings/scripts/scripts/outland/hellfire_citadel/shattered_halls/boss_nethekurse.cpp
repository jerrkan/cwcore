...
struct CW_DLL_DECL boss_grand_warlock_nethekurseAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_fel_orc_convertAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_lesser_shadow_fissureAI : public ScriptedAI
{
