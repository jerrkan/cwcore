...
struct CW_DLL_DECL mob_abyssalAI : public ScriptedAI
{
...
struct CW_DLL_DECL boss_magtheridonAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_hellfire_channelerAI : public ScriptedAI
{
