...
struct CW_DLL_DECL npc_manaforge_control_consoleAI : public ScriptedAI
{
...
//TODO: clean up this workaround when CW adds support to do it properly (with gossip selections instead of instant summon)
...
struct CW_DLL_DECL npc_commander_dawnforgeAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_phase_hunterAI : public ScriptedAI
{
...
struct CW_DLL_DECL npc_bessyAI : public npc_escortAI
{
