...
struct CW_DLL_DECL boss_alarAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_ember_of_alarAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_flame_patch_alarAI : public ScriptedAI
{
