...
struct CW_DLL_DECL npc_aeranasAI : public ScriptedAI
{
...
struct CW_DLL_DECL npc_ancestral_wolfAI : public npc_escortAI
{
...
struct CW_DLL_DECL npc_wounded_blood_elfAI : public npc_escortAI
{
