...
struct CW_DLL_DECL molten_flameAI : public NullCreatureAI
{
...
struct CW_DLL_DECL boss_supremusAI : public ScriptedAI
{
...
struct CW_DLL_DECL npc_volcanoAI : public Scripted_NoMovementAI
{
