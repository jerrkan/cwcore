...
struct CW_DLL_DECL mob_unkor_the_ruthlessAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_infested_root_walkerAI : public ScriptedAI
{
...
## mob_skywing
######*/
struct CW_DLL_DECL npc_skywingAI : public npc_escortAI
{
public:
...
struct CW_DLL_DECL mob_rotting_forest_ragerAI : public ScriptedAI
{
...
struct CW_DLL_DECL mob_netherweb_victimAI : public ScriptedAI
{
...
struct CW_DLL_DECL npc_floonAI : public ScriptedAI
{
...
struct CW_DLL_DECL npc_isla_starmaneAI : public npc_escortAI
{
...
struct CW_DLL_DECL npc_akunoAI : public npc_escortAI
{
