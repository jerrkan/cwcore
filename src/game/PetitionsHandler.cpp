...
void WorldSession::HandlePetitionShowSignOpcode(WorldPacket & recv_data)
{
    ...
    data << petitionguid_low;                               // guild guid (in CW always same as GUID_LOPART(petitionguid)
...
void WorldSession::HandlePetitionQueryOpcode(WorldPacket & recv_data)
{
    ...
    uint32 guildguid;
    uint64 petitionguid;
    recv_data >> guildguid;                                 // in CW always same as GUID_LOPART(petitionguid)
    recv_data >> petitionguid;                              // petition guid
...
void WorldSession::SendPetitionQueryOpcode(uint64 petitionguid)
{
    ...
    data << GUID_LOPART(petitionguid);                      // guild/team guid (in CW always same as GUID_LOPART(petition guid)
...
void WorldSession::HandleOfferPetitionOpcode(WorldPacket & recv_data)
{
    ...
    data << petitionguid;                                   // petition guid
    data << _player->GetGUID();                             // owner guid
    data << GUID_LOPART(petitionguid);                      // guild guid (in CW always same as GUID_LOPART(petition guid)
    data << signs;                                          // sign's count
