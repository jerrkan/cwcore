...
#ifndef CW_TARGETEDMOVEMENTGENERATOR_H
#define CW_TARGETEDMOVEMENTGENERATOR_H
...
class CW_DLL_SPEC TargetedMovementGeneratorBase
{
    public:
...
template<class T>
class CW_DLL_SPEC TargetedMovementGenerator
