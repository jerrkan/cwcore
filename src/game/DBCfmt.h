...
const char FactionEntryfmt[]="niiiiiiiiiiiiiiiiiissssssssssssssssssssxxxxxxxxxxxxxxxxxx";
...
const char MapEntryfmt[]="nxixxssssssssssssssssxixxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxixiffxixi";
