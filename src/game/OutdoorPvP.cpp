...
bool OPvPCapturePoint::Update(uint32 diff)
{
    ...
    CW::AnyPlayerInObjectRangeCheck checker(m_capturePoint, radius);
    CW::PlayerListSearcher<CW::AnyPlayerInObjectRangeCheck> searcher(m_capturePoint, players, checker);
