...
void Spell::EffectSanctuary(uint32 /*i*/)
{
    ...
    CW::AnyUnfriendlyUnitInObjectRangeCheck u_check(unitTarget, unitTarget, m_caster->GetMap()->GetVisibilityDistance());
    CW::UnitListSearcher<CW::AnyUnfriendlyUnitInObjectRangeCheck> searcher(unitTarget, targets, u_check);
