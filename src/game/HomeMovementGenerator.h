...
#ifndef CW_HOMEMOVEMENTGENERATOR_H
#define CW_HOMEMOVEMENTGENERATOR_H
...
template < class T >
class CW_DLL_SPEC HomeMovementGenerator;

template <>
class CW_DLL_SPEC HomeMovementGenerator<Creature>
