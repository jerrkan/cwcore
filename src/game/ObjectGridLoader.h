...
#ifndef CW_OBJECTGRIDLOADER_H
#define CW_OBJECTGRIDLOADER_H
...
class CW_DLL_DECL ObjectGridUnloader
{
    public:
...
class CW_DLL_DECL ObjectGridStoper
{
    public:
...
class CW_DLL_DECL ObjectGridCleaner
{
    public:
