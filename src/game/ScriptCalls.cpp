...
bool LoadScriptingModule(char const* libName)
{
    ...
    if(   !(testScript->ScriptsInit         =(scriptCallScriptsInit         )CW_GET_PROC_ADDR(testScript->hScriptsLib,"ScriptsInit"         ))
        ...
        ||!(testScript->OnLogout            =(scriptCallOnLogout            )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnLogout"            ))
        ||!(testScript->OnPVPKill           =(scriptCallOnPVPKill           )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnPVPKill"           ))
        ||!(testScript->OnSpellCast         =(scriptCallOnSpellCast         )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnSpellCast"         ))
        ||!(testScript->OnGetXP             =(scriptCallOnGetXP             )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnGetXP"             ))
        ||!(testScript->OnGetMoney          =(scriptCallOnGetMoney          )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnGetMoney"          ))
        ||!(testScript->OnPlayerChat        =(scriptCallOnPlayerChat        )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnPlayerChat"        ))
        ||!(testScript->OnServerStartup     =(scriptCallOnServerStartup     )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnServerStartup"     ))
        ||!(testScript->OnServerShutdown    =(scriptCallOnServerShutdown    )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnServerShutdown"    ))
        ||!(testScript->OnAreaChange        =(scriptCallOnAreaChange        )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnAreaChange"        ))
        ||!(testScript->OnItemClick         =(scriptCallOnItemClick         )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnItemClick"         ))
        ||!(testScript->OnItemOpen          =(scriptCallOnItemOpen          )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnItemOpen"          ))
        ||!(testScript->OnGoClick           =(scriptCallOnGoClick           )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnGoClick"           ))
        ||!(testScript->OnCreatureKill      =(scriptCallOnCreatureKill      )CW_GET_PROC_ADDR(testScript->hScriptsLib,"OnCreatureKill"      ))
