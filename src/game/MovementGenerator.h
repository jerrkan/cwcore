...
#ifndef CW_MOVEMENTGENERATOR_H
#define CW_MOVEMENTGENERATOR_H
...
class CW_DLL_SPEC MovementGenerator
{
    public:
...
class CW_DLL_SPEC MovementGeneratorMedium : public MovementGenerator
{
    public:
